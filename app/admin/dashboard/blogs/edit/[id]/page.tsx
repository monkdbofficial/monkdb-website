    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          googleDriveUrl: blog.googleDriveUrl || "",
          documentFile: blog.documentFile || "",
        ...
        // Set useFileUpload based on whether files are uploaded
        if (blog.videoFile || blog.documentFile) {
