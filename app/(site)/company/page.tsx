          ...
          <div className="w-full px-4">
            <div className="mx-auto max-w-[900px] text-center">
              ...
              <motion.div
                ...
                className="group relative mx-auto mb-12 flex h-48 w-48 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-primary to-blue-600 shadow-xl"
                whileHover={{
                  scale: 1.05,
                  boxShadow:
              ...
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-tr from-blue-600/30 to-transparent"
                  animate={{
                    rotate: [0, 360],
                  }}
                  transition={{
                ...
                <div className="absolute inset-2 flex items-center justify-center rounded-full border-4 border-white/20 bg-gradient-to-br from-primary/90 to-blue-700">
                  {/* N Letter with stylish effect */}
                  <span className="relative text-7xl font-bold text-white drop-shadow-lg">
                    N
                    <span className="absolute inset-0 text-7xl font-bold text-blue-200/50 blur-sm">
                      N
                    </span>
                  </span>
                </div>
              ...
              >
                ...
                cutting-edge development. We transform ideas into exceptional
              ...
              >
                <Link
                  href="mailto:info.nextgendigitalcraft@gmail.com"
                ...
                >
                  ...
                  <span className="font-medium">
                    info.nextgendigitalcraft@gmail.com
                  </span>
                </Link>
                <Link
                  href="https://nextgendigitalcraft.com"
                  target="_blank"
