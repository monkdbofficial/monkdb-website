...
const NEVER_TRANSLATE = new Set([
  ...
  'MonkSmartX SmartFinance',
  'MonkSmartX SmartMine',
  'MonkSmartX SmartMobility',
  'MonkSmartX SmartRetail',
  'MonkSmartX SmartTrade',
  'MonkSmartX SmartManufacturing',

  // ---- Competitor / partner / vendor brand names ----
  'Greptime',
  'AutoMQ',
  'dbend Cloud',
  'dbend Enterprise',
  ...
  // ---- Languages / runtimes (proper-noun tech names) ----
  'Python',
  'TypeScript',
  'Java',
  'Rust',
