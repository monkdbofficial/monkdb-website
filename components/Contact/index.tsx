              ...
              <form onSubmit={handleSubmit} className="space-y-7.5">
                ...
                <div className="flex flex-wrap items-center gap-4 xl:justify-between">
                  <label
                    ...
                    className="mb-4 flex cursor-pointer items-center md:mb-0"
                  >
                    <input
                      id="default-checkbox"
                      type="checkbox"
                    ...
                    />
                    <span className="group flex h-5 min-w-[20px] items-center justify-center rounded border border-gray-300 bg-white text-blue-600 peer-checked:border-primary peer-checked:bg-primary dark:border-gray-600 dark:bg-gray-700">
                      <svg
                    ...
                    <span className="ml-3 max-w-[425px] select-none text-sm">
